import Quote from "./QuoteConstructor";
...
export const QUOTES = [
	...
	new Quote(
		"Anonymous",
		"A friend by your side can keep you warmer than the most expensive coat."
	),
	new Quote(
		"Hugh Downs",
	...
	new Quote("Jewish Proverb", "A mother understands what a child does not say."),
	new Quote(
		"Richard L. Evans",
		"A person soon learns how little he knows when a child begins to ask questions."
	),
	new Quote("Mohammed", "A person's true wealth is the good he or she does in the world."),
	new Quote(
		"Unknown",
	...
	new Quote("Unknown", "A smile confuses an approaching frown."),
	new Quote("Phyllis Diller", "A smile is a curve that sets everything straight. "),
	new Quote(
		"David Brinkley",
	...
	new Quote("Leonardo Da Vinci", "A well-spent day brings happy sleep."),
	new Quote(
		"Mae West",
		"A woman has got to love a bad man once or twice in her life to be thankful for a good one."
	),
	new Quote("Karen Lamb", "A year from now you will wish you had started today."),
	new Quote(
		"Lou Holtz",
	...
	new Quote("Anonymous", "Aim high. Chances are, you won't be disappointed."),
	new Quote(
		"Judy Garland",
	...
	new Quote(
		"Unkown",
		"Always remember that in some way or another you’re somebody’s angel, even if you don't know it…"
	),
	new Quote(
		"Ann Landers",
